...
def save_thank_you_note(str_name, str_note_text):
    """
    Save note to text file
    :param str_name: Donor name
    :param str_note_text: Note text
    :return: None
    """
...
def generate_donations_report(lst_donations, lst_unique_donors):
    """
...
def print_donations_report():
    lst_donations = read_donations_file()
    lst_unique_donors = unique_donors(lst_donations)
    donations_report = generate_donations_report(lst_donations, lst_unique_donors)
...
def add_new_donation():
    ...
    # TODO: Move user inputs outside of function
...
def thank_you_menu():
    ...
    while str_name != 'q':
        ...
        if str_name == 'list':
            ...
            str_note_text = send_thank_you(str_name, str_last_donation)
            save_thank_you_note(str_name, str_note_text)
            print('\n\n' + str_note_text)
